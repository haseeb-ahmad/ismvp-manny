...
Devise.setup do |config|
  ...
  config.omniauth :linkedin, LINKEDIN_CONFIG[:app_id], LINKEDIN_CONFIG[:app_secret], { scope: "r_fullprofile r_basicprofile r_emailaddress rw_company_admin w_share", name: 'linkedin', authorize_params: { state: SecureRandom.hex(15)} }
